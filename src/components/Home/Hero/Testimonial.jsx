...
const Testimonial = () => {
  ...
  return (
    <div className="bg-[url(https://c4.wallpaperflare.com/wallpaper/74/457/102/life-room-interior-home-wallpaper-preview.jpg)] bg-no-repeat bg-cover bg-black/60 bg-blend-overlay w-full  text-white p-20 ">
      <div className="">
        <img
          src={logo}
          alt="logo"
      ...
      <div className="flex item-start overflow-x-auto  cursor-grab active:cursor-grabbing testimonial-scroll gap-4"
      ref={scrollRef}
      ...
      >
       {testimonials.map((testimonial, index) => (
        <div
          key={index}
          className="p-6  bg-white rounded shadow-md gap-4 "
        >
            <div className="w-[400px] relative">
                <span className="absolute -top-16 z-10 right-3">
                    <FaQuoteLeft className="text-6xl shadow p-4 rounded-full bg-[#00b4d8] "/>
                </span>
